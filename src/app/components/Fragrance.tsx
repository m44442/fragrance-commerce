      ...
      <div className="flex flex-col items-center m-4">
        <a className="cursor-pointer shadow-2xl duration-300 hover:translate-y-1 hover:shadow-none">
          <Image
            ...
            alt={fragrance?.title || "香水のタイトル"}
            width={450}
            height={350}
            className="rounded-t-md"
          />
          <div className="px-4 py-4 bg-slate-100 rounded-b-md">
            <h2 className="text-lg font-semibold">{fragrance.title}</h2>
            <p className="mt-2 text-lg text-slate-600">説明</p>
            <p className="mt-2 text-md text-slate-700">値段：{fragrance.price}円</p>
          </div>
        </a>
